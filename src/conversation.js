...
import {Timecoin, TIMECOIN_CHANNEL, TIMECOIN_CHANNEL_NAME} from './timecoin';


// jshint ignore:start
const Conversation = ({conversation: {partner, context, channels: {chat, issues, time, game, location, timecoin}}}, {partners, mutation}) => (
  <conversation className={context.iceConnectionState}>
    ...
    <channels>
      ...
      {timecoin ? <Timecoin timecoin={timecoin} /> : undefined}
    </channels>
  </conversation>
);
// jshint ignore:end
...
export {Conversation, CHAT_CHANNEL, CHAT_CHANNEL_NAME, ISSUES_CHANNEL, ISSUES_CHANNEL_NAME, GAME_CHANNEL, GAME_CHANNEL_NAME, TIME_CHANNEL, TIME_CHANNEL_NAME, LOCATION_CHANNEL, LOCATION_CHANNEL_NAME, TIMECOIN_CHANNEL, TIMECOIN_CHANNEL_NAME};
