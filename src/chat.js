...
const CHAT_CHANNEL = createChannelHandler(CHAT_CHANNEL_NAME, ADD_CHAT_MESSAGE, (partner, channel) => ({partner, channel, start: new Date().getTime(), messages: [], input: {message: undefined}}));

export {Chat, CHAT_CHANNEL, CHAT_CHANNEL_NAME};